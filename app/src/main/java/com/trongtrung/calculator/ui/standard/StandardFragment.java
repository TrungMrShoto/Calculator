...
public class StandardFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        standardViewModel = ViewModelProviders.of(this).get(StandardViewModel.class);

        View root = inflater.inflate(R.layout.fragment_standard, container, false);

        final TextView textView = root.findViewById(R.id.text_standard);

        standardViewModel.getText().observe(this, new Observer<String>() {
            @Override
